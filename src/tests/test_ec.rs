...
fn test_ec() {
    ...
    let message = crate::metadata::get_codewords(&bitstream,str.chars().count(),crate::qr::Encoding::Byte,6,28);
...
fn test_ec_grouping() {
    ...
    let message = crate::metadata::get_codewords(&bitstream,str.chars().count(),crate::qr::Encoding::Byte,6, 88);
